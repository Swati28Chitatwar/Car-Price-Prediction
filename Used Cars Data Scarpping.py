...
url  = 'https://www.carsdekho.com/buy-used-honda-cars-delhi-ncr/'
...
while cars_no < 42:
    for table in tables:
        ...
        link = 'https://www.carsdekho.com/' + table.find('a', {'class': 'qD5mC'}).get('href')
        ...
        no_page =  no_page + 1
        no_page =  str(no_page)
        url     = 'https://www.carsdekho.com/buy-used-honda-cars-delhi-ncr/' + '?page=' + no_page
        no_page =  int(no_page)
...
cars_dict_df.to_csv('cars_data.csv')
